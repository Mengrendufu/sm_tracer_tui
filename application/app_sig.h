...
enum AppSignals {
    ...
    SPMNGR_CONFIG_APPLIED_SIG,
    SPMNGR_CONFIG_APPLY_FAILED_SIG,
    SPMNGR_LOAD_PROTOCOL_SIG,
    SPMNGR_PORT_CONNECT_SIG,
    SPMNGR_PORT_OPENED_SIG,
    SPMNGR_PORT_ALREADY_CONNECTED_SIG,
    SPMNGR_PORT_OPEN_FAILED_SIG,
    SPMNGR_PORT_DISCONNECT_SIG,
    SPMNGR_PORT_CLOSED_SIG,
    SPMNGR_PORT_CLOSE_FAILED_SIG,
    SPMNGR_PORT_CONNECTION_LOST_SIG,
    SPMNGR_REFRESH_PROTOCOLS_SIG,
